...
<body>	
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<div><br/></div>
	<div id="score" class="container row" style="width:20px"  style="background-color:lightpink;" ><div ><lable id="lablescore" class="col-xs-6 col-md-4">Score=0</lable></div><div> <h5> <br/></h5></div></div>
			...
			if(event.handled !== true){
			   ...
			   var c1=$('#identy .owl-carousel').eq(index);
				...
				content1.closest('.owl-carousel').find('.glyphicon-ok').addClass('glyphicon-remove');
				 html3.html(content1);
				var scorepatern=parseInt(ScorePattern);
				 //arrayapprove.push(pattern_sequence);
				...
				$('#approvepatterndiv').append(html3);
				  ...
				  $.ajax({
                    type: "POST",
                    url: "insert.php",
                    data: {"pattern_sequence":  pattern_sequence , "userid": userid , "ScorePattern": scorepatern},
