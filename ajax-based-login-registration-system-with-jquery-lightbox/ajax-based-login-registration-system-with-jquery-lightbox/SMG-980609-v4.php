	   ...
	   var flagstr="";
			$('.owl-carousel').each(function(index){
				...
				var item2=$('.owl-item.active').eq(((k)*22)+i);
					...
					if(flag==0){
						var tempreverse1=$("#content").closest('.divrow').find('.isreversediv .isreverselable').eq(index).text();
						var tempreverse2=$("#content").closest('.divrow').find('.isreversediv .isreverselable').eq(k).text();
						if(tempreverse1=='yes'||tempreverse2=='yes'){flagrev=flagrev+'yes';}
						else {flagrev=flagrev+'no';}
