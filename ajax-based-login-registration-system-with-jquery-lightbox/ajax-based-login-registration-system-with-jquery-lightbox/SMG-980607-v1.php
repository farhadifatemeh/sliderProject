...
function reverseslider(){
		$("#content .divrow").click(function(event){
			if(event.handled !== true){
				...
				par1.data('owlCarousel').options.rtl = true;
				par1.trigger( 'refresh.owl.carousel' );
	/*			var $carousel = $(this).closest('.divrow').find('.owl-carousel').eq(0);
             var owl = $carousel.data('owlCarousel');
			//	# Your DOM element gets an 'owlCarousel' data property containing the Owl object. 
owl.reinit({touchDrag: false, mouseDrag: false});*/
			//alert(par1);
			//alert(par.index());
				//var cpar=par1.clone();
				//par1.remove();
				//$(this).closest('.divrow').find('.owl-carousel').eq(0).append(cpar);
