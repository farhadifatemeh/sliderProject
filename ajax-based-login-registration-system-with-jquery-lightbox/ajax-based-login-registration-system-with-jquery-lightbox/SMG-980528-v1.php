...
<body>	
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<div id="score" class="container row"><div ><lable id="lablescore" class="col-xs-6 col-md-4">Score=1</lable></div><div ><lable id="lablehighscore" class="col-xs-6 col-md-4">HighScore=0</lable></div><div> <h5> <br/></h5></div></div>
...
<div id="content" class="div container">
	...
	<div id="testclone" class="row embed-responsive">
		<div  class="container">
			<br/>
   <button  type="button" id="add" class="btn btn-outline-primary btn-md ">Add</button>
</div>
		<div width="3px"><h5>   </h5></div>
</div>
	<div id="bottom1 row">
			...
			$('#identy .owl-carousel').each(function(index){
				...
				if(arraypattern[i]==c){
					...
					fl=0;
						...
						if(fl==1){
							var original_image1 = 'url(tik1.jpg)';
							var original_image2 = 'url(tik2.jpg)';
								var str="";
								str=arraypattern[i];
...
/*	$(html).append($("<div>").css("background-color","#FF0000")
	...
	function hoverdivOpen(e){
		...
		$('#identy .owl-carousel').hover(function () {
    ...
    $('.owl-carousel').each(function(index){
		...
		function deleteapprovepattern(){
			var delflag=1;
			$('#identy .owl-carousel').click(function(e){
				if(delflag==1){
					var index = $('#identy .owl-carousel').index(this);
		...
		$("#content").on("dblclick",function(index){
$(this).children(index).moveUp();                                                                       
			});
				$.fn.moveUp = function() {
    $.each(this, function() {
